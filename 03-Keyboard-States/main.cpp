...
#define ID_SPRITE_FIREBALL 30001
...
void LoadResources()
{
	...
	// Fire ball object
	sprites->Add(ID_SPRITE_FIREBALL, 568, 118, 568 + 11, 118 + 11, texMisc);
	sprites->Add(ID_SPRITE_FIREBALL+1, 580, 118, 580 + 11, 118 + 11, texMisc);

	ani = new CAnimation(100);
	ani->Add(ID_SPRITE_FIREBALL);
