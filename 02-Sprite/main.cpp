...
void LoadResources()
{
	...
	//sprites của brick_1
	sprites->Add(20011, 300, 136, 317, 151, texMisc);
	sprites->Add(20012, 318, 136, 335, 151, texMisc);
	sprites->Add(20013, 336, 136, 353, 151, texMisc);
	sprites->Add(20014, 354, 136, 371, 151, texMisc);
	...
	brick_1 = new CBrick(50.0f, MARIO_START_Y, 1);
}
